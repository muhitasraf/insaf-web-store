...
if(isset($_POST['edit_profile'])){
		...
		$update_profile = mysqli_query($con,"update users set user_name = '$user_name', user_city = '$user_city', user_address = '$user_address' user_contact ='$user_contact' where user_id = '$_SESSION[user_id]'");
